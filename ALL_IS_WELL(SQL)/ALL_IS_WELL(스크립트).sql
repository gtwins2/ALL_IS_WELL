...
CREATE TABLE "CHATTING_ROOM" (
	...
	SENDER_STATUS	CHAR(1)	DEFAULT 'O'	NOT NULL,
	RECEIVER_STATUS	CHAR(1)	DEFAULT 'O'	NOT NULL
);
...
ALTER TABLE CHATTING ADD CONSTRAINT FK_CHATTING_ROOM_TO_CHATTING_1 FOREIGN KEY (
	ROOM_NO
)
